<%-- 
    ...
    Created on : 25-may-2017, 16:28:27
    Author     : camilo
--%>
                    ...
                    <div class="row">
                        <c:forEach items="${datos}" var="datos">
                            <div class="col-lg-4 col-md-12">
                                <embed src="<c:out value="${datos.archivo}"/>" alt="Thumbnail Image" class="rounded img-raised img-responsive" width='350' height='400'>
                                <p>
                                <h6> <c:out value="${datos.nombre}"/></h6>
                                <p>
                                <h5><c:out value="${datos.fecha}"/></h5>
                                <p>
